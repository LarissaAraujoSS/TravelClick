...
echo("f:  ".$flagReservaFPS1362);
            }//fecha while

              if(${"flagReserva".$placa_escolhida}==true){
                echo("carro ".$placa_escolhida." escolhidov disponivel");
                echo("flagReserva ".${"flagReserva".$placa_escolhida}." ");
                echo("flagReservaFPS1362 ".$flagReservaFPS1362." ");
              }
